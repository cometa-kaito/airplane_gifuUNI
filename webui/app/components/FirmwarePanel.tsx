...
export function FirmwarePanel({
  ...
  return (
    <details className="rounded-xl bg-white shadow-card ring-1 ring-indigo-200/70">
      <summary className="px-5 py-4 cursor-pointer select-none hover:bg-slate-50/60 transition-colors rounded-xl">
        <span className="inline-flex items-center gap-3">
          <span
            className="flex-none w-8 h-8 rounded-lg bg-indigo-50 text-indigo-600 ring-1 ring-indigo-100
          ...
          <span className="leading-tight">
            <span className="block text-sm font-semibold text-slate-800 tracking-tight">
              Firmware · 入手 &amp; 機体ペアリング
            </span>
            <span className="block text-xs text-indigo-600 mt-0.5 font-medium">
              はじめての方はここから（初回セットアップ）
            </span>
          </span>
        </span>
      </summary>
